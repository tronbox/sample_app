...
describe "ordenes_servicios/new" do
  before(:each) do
    assign(:orden_servicio, stub_model(OrdenServicio,
      :folio => 1,
  ...
  it "renders new orden_servicio form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => ordenes_servicios_path, :method => "post" do
